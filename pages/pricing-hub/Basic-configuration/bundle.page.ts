...
/**
 * BundlePage — Page Object for the Bundle screen.
 *
 * Accessed via: Pricing Hub → Bundle Management
 */
export class BundlePage extends BasePage {
  ...
  /** Hover on "Pricing Hub" → click "Bundle management" link. */
  async navigateViaNav(): Promise<void> {
    await this.hoverNavMenu(/Pricing Hub/i);
    await this.clickNavLink(/Bundle Management/i, /bundle-management/i);
